...
<form name="fileupload" enctype="multipart/form-data" action="/a/uploadFileAndImport" method="post">
    <div >
...
<table border="1">
    ...
    <a href="/a//exportTemplate" class="btn btn-link">点击下载模板文件</a>
    <a href="/a/backCampus" class="btn btn-link">返回上一页</a>
    </div>
    </div>
</body>
